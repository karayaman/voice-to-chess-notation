...
def has_square_image_changed(old_square,
                             new_square):  # If there has been a change -> the image difference will be non null -> the average intensity will be > treshold
